...
#SBATCH --job-name=KL    # create a short name for your job
#SBATCH --nodes=1
#SBATCH --output=logs/%x-%j.log
#SBATCH --mail-user=eddyliu@umich.edu
#SBATCH --mail-type=END,FAILED
#SBATCH --account=adraelos0
...
#SBATCH --time=400:00:00         # total run time limit (HH:MM:SS)
...
python cyclegan_kl_greatlakes_compute.py --results-rootn results --output-dir results/KL_out
